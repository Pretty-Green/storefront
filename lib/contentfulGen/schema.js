...
// COPIED FROM https://github.com/contentful/contentful-import/blob/master/lib/utils/schema.js
// VERSION TAG 9.0.8
  ...
  fields: Joi.array()
    ...
    .items(
      Joi.object().keys({
        ...
        type: Joi.string()
          .required()
          .regex(/^Symbol|Text|Integer|Number|Date|Object|Boolean|Array|Link|Location$/),
        validations: Joi.array(),
        disabled: Joi.boolean(),
        omitted: Joi.boolean(),
        required: Joi.boolean(),
        localized: Joi.boolean(),
        linkType: Joi.string().when('type', {
          is: 'Link',
          then: Joi.string().regex(/^Asset|Entry$/),
